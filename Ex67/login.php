...
?>
  ...
  <body style="background-color:black">
    <div class="container" style="
        ...
        ">
      <div>
        <button type="button" class="btn btn-primary" style="max-width: 60px; max-height: 40px;"><a style="text-decoration: none; color: white;" href="./index.php">Назад</a></button>
      </div>
      <form class="form_loginin" action="" method="post" style="padding: 10px;">
        ...
        <div class="mb-3">
          <label for="exampleInputUsername" class="form-label" style="font-size:20px;">Имя пользователя</label>
          <input type="text" name="login" class="form-control" placeholder="Login" value="<?php if (!empty($_COOKIE['login'])) print $_COOKIE['login']; ?>">
        </div>
        <div class="mb-3">
          <label for="exampleInputPassword1" class="form-label" style="font-size:20px;">Пароль</label>
        ...
        <div class="text-center m-2">
          <button type="button" class="btn btn-primary"><a href="./admin.php" style="text-decoration: none; color: white;">Войти как администратор</a></button>
        </div>
      </form>
    </div>
  </body>
