...
<body style="background-color:cadetblue;">
    <div class="container-fluid container-md">
        <div class="row m-1 p-1 justify-content-center">
            <div class="col-sm-4">
                <div id="navbar">
                    <nav class="navbar navbar-black " style="background-color:lightpink">
                        <ul class="nav nav-pills ">
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="#">Форма</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="./logout.php" style="color: black;">Выйти</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="./login.php" style="color: black;">Войти в аккаунт</a>
                            </li>
                        </ul>
                    </nav>
                </div>
                ...
                <div id="forma" class="col m-1 p-1 rounded-3 border border-dark d-flex justify-content-center text-center" style="background-color:darkgrey;">
                    <form class="formula col-10" action="" method="POST">
                        <h2 id="forma" style="color:darkorchid" class="undershape text-center">Форма</h2>
                        <div id="name" class="form_item input-group mb-3">
                            <span class="input-group-text">Name </span>
                            <input type="text" name="fio" class="form-control <?php if ($errors['fio']) print 'border border-danger'; ?>" placeholder="Имя" value="<?php if ($values['fio']) print $values['fio']; ?>">
                        </div>
                        <div id="email" class="form_item input-group mb-3">
                            <span class="input-group-text">E-mail </span>
                            <input type="email" name="email" class="form-control <?php if ($errors['email']) print 'border border-danger'; ?>" placeholder="e-mail" value="<?php if ($values['email']) print $values['email']; ?>">
                        </div>
